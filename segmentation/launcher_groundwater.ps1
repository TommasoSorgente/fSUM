...
$dim = 2
$mesh_path = "$SCRIPTDIR/../data/Groundwater_section/mesh.obj"
$field_path = "$SCRIPTDIR/../data/Groundwater_section/field.csv"
$field_type = 1
$FGLOBAL = 0
$fieldG_path = "."
...
if ($isoval_vals -ne $null -and $isoval_vals.Count -gt 0) {
